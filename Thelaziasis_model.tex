...
\section{Optimal Controlled Model}
    ...
    medium worm burden and let $v_h(t)$ the manual removal of worms.
    ...
    contribution due to the respective class or strategy.
        ...
        Then, our problem will be minimize $J$ subject to the controlled
    dynamics governed by \cref{Eq:SIvectorhostmodel_v2controlled}, that is, we
    want to solve the following optimization problem.

    \begin{equation}{\label{eqn:optimal_problem}}
        \begin{aligned}
    ...
    have to existence of a control
   $
